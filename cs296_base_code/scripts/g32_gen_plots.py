...
x,x1,x2,x3,y=np.loadtxt('./data/g32_data_01.csv',delimiter=',',usecols=(2,3,4,5,6),unpack=True)
...
plt.savefig('./doc/g32_plot01.png')
plt.close()
...
plt.savefig('./doc/g32_plot02.png')
plt.close()
...
plt.savefig('./doc/g32_plot03.png')
plt.close()
...
plt.xlabel('Time')
plt.ylabel('Freq(no of reruns)')
plt.savefig('./doc/g32_plot04.png')
plt.close()
...
plt.savefig('./doc/g32_plot05.png')
plt.close()
